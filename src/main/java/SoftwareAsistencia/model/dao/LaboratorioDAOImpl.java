...
public class LaboratorioDAOImpl implements LaboratorioDAO {
    ...
    @Override
public List<Laboratorio> obtenerDatosLaboratorio(Timestamp horarioHoraInicio, Timestamp horarioHoraFin, 
        int laboratorioUbicacion, String laboratorioNombre) throws SQLException {
